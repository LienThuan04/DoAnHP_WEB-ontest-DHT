// Port từ DHT_OneTest/public/js/pages/select_question.js — chỉ đổi đường dẫn
// AJAX/redirect tương đối "./" → tuyệt đối "/" (NestJS không có <base>, trang ở
// /test/select/:made nên "./" sẽ resolve sai). Logic giữ nguyên.

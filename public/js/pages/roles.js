// Port từ DHT_OneTest/public/js/pages/roles.js — chỉ đổi URL tương đối
// ('./roles/..') sang tuyệt đối ('/roles/..') cho khớp route NestJS (path gốc).
Dashmix.onLoad(() =>
  class {
...
$(document).ready(function () {
  ...
  // Toggle user status from modal — endpoint /user/setStatus sẽ có ở module users (Phase 2).
